    ...
    <section>
      <div className={`relative flex items-center justify-center bg-gradient-to-br from-[${banner[0]}] to-[${banner[1]}] w-full h-64`}>
        <div
          ...
          className="cursor-pointer absolute flex gap-2 items-center justify-center text-sm top-4 left-4 text-white">
          <svg
        ...
        <ColorExtractor getColors={setBannerColorHandler}>
          <img
            className="absolute -bottom-20 w-52 h-52 bg-gradient-to-t from-gray-100/30 rounded-full border-2 border-white"
            draggable="false"
            src={trainer.icon}
            alt="Logo treinador(a) pokemon" />
        </ColorExtractor>
      </div>
